...
func (s Service) AdminGetDetail(ctx context.Context, id int64) (entity.Hall, error) {
...
func (s Service) BranchGetDetail(ctx context.Context, id int64) (entity.Hall, error) {
...
func (s Service) CashierGetDetail(ctx context.Context, id int64) (entity.Hall, error) {
...
func (s Service) WaiterGetList(ctx context.Context, filter Filter) ([]WaiterGetList, int, error) {
