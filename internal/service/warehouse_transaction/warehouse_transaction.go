...
func (s Service) AdminGetList(ctx context.Context, filter Filter) ([]AdminGetListResponse, int, error) {
...
func (s Service) BranchGetList(ctx context.Context, filter Filter) ([]BranchGetListResponse, int, error) {
