...
func (s Service) AdminGetList(ctx context.Context, filter Filter, foodID int64) ([]AdminGetListByFoodID, int, error) {
...
func (s Service) BranchGetList(ctx context.Context, filter Filter, foodID int64) ([]BranchGetListByFoodID, int, error) {
