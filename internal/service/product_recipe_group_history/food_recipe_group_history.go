...
func (s Service) BranchGetList(ctx context.Context, filter Filter) ([]BranchGetListByProductID, int, error) {
...
func (s Service) AdminGetList(ctx context.Context, filter Filter) ([]AdminGetListByProductID, int, error) {
