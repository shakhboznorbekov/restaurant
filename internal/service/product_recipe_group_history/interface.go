...
type Repository interface {
	...
	AdminGetList(ctx context.Context, filter Filter) ([]AdminGetListByProductID, int, error)
	...
	BranchGetList(ctx context.Context, filter Filter) ([]BranchGetListByProductID, int, error)
