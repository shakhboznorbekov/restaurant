...
func (s Service) AdminGetDetail(ctx context.Context, id int64) (entity.Foods, error) {
...
func (s Service) BranchGetDetail(ctx context.Context, id int64) (entity.Foods, error) {
...
func (s Service) BranchDeleteImage(ctx context.Context, request AdminDeleteImageRequest) error {
	return s.repo.BranchDeleteImage(ctx, request)
}
