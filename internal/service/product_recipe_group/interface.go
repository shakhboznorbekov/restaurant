...
type Repository interface {
	...
	AdminGetList(ctx context.Context, filter Filter, productID int64) ([]AdminGetListByProductID, int, error)
	...
	BranchGetList(ctx context.Context, filter Filter, productID int64) ([]BranchGetListByProductID, int, error)
