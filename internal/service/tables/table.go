...
func (s Service) AdminGetDetail(ctx context.Context, id int64) (entity.Table, error) {
...
func (s Service) BranchGetDetail(ctx context.Context, id int64) (entity.Table, error) {
